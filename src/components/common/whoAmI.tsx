...
const WhoAmI = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <section className="md:-pt-10 my-35 mb-100 flex flex-col items-center justify-start pt-40 text-center md:mb-60 md:pt-0">
      <AnimatedSection>
      ...
      <AnimatedSection delay={0.2}>
        <p className="text-foreground/66 mt-4 text-xl font-medium lg:text-2xl">
          Software Engineer
        </p>
      </AnimatedSection>
      <AnimatedSection delay={0.4}>
        <p className="text-foreground/66 text-md mt-2 text-center font-medium lg:text-lg">
